...
CF = -O3 -march=$(ISA) -mabi=$(ABI) -mcmodel=medany -fno-builtin -ffunction-sections -fdata-sections -nostartfiles -nostdlib -nostdinc -static -lgcc -Werror -Wl,--nmagic -Wl,--gc-sections 
CFLAG = ${CF} ${INCLUDE} -g -DPRIORITY
